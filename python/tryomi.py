...
while True:
	...
	if ret:
		debug = frame
		cv2.imshow("picture",debug)
		if cv2.waitKey(100) & 0xFF == ord('q'):
			counter = counter + 1
			if counter < 10:
				cv2.imwrite('/Users/bigphess/Desktop/Notes/OpenCV/calibration/first0'+str(counter)+'.jpg',debug)
				print("successful write")
			else:
				cv2.imwrite('/Users/bigphess/Desktop/Notes/OpenCV/calibration/first'+str(counter)+'.jpg',debug)
				print("successful write")
	else:
		print("fail open")
		break
